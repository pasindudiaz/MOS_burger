...
function additem() {
    console.log("hello");
    itemdetails.push({
        itemcode: document.getElementById("nameBtn2").innerText,
        itemcategory: document.getElementById("categoryBtn").innerText,
        itemname: document.getElementById("nameBtn").innerText,
        itemquantity: document.getElementById("quantityfield").value,
        itemprice: document.getElementById("pricefield").value,
        itemdiscount: document.getElementById("discountfield").value,
        itemexpire: document.getElementById("expirefield").value
    });
